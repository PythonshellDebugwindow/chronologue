export const consonantPhones = [
  "m̥ m ɱ̊ ɱ n̪̊ n̪ n̥ n * * ɳ̊ ɳ ȵ̊ ȵ ɲ̊ ɲ * * ŋ̊ ŋ ɴ̥ ɴ * * * * * *",
  "p b p̪ b̪ t̪ d̪ t d * * ʈ ɖ ȶ ȡ c ɟ * * k g q ɢ ʡ * ʔ * * *",
  "p͡ɸ b͡β p̪͡f b̪͡v t̪͡θ d̪͡ð t͡s d͡z t͡ʃ d͡ʒ ʈ͡ʂ ɖ͡ʐ t͡ɕ d͡ʑ c͡ç ɟ͡ʝ * * k͡x g͡ɣ q͡χ ɢ͡ʁ * * * * t͡ɬ d͡ɮ",
